<html>
    <head>
        <title>JMHN : Add Credit Card</title>
...
.logindown:hover .dropbtn {background-color: #3e8e41;}
    ...
    <body>
        ...
        <div style="text-align:center">
           ...
           <input type="text" id="logbox" placeholder="Owner Name" name="cname" maxlength="40" required><br><br><br><br><br>
           <input type="text" id="logbox" placeholder="Credit Card ID" name="cid" maxlength="16" required><br><br><br><br><br>
           <input type="month" id="logbox" placeholder="Expire Date" required><br><br><br><br><br>
           <input type="text" id="logbox" placeholder="CVC/CVV" name="cvv" maxlength="4" required><br><br><br><br><br>
           <a href="index.php"><input type="submit" id="logbut" name="add" value="Continue"></a><br><br>
           <a href="index.php" id="sinen">Skip Now</a>
        </form>
        </div>
        <br>
        <br>
