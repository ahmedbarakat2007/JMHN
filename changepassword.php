<html>
    <head>
        <title>JMHN : Change Your Password</title>
  ...
  border:solid 1px black;
    ...
    <body>
        ...
        <div class="aboutmain1">
            ...
            <br>
            <br>
            <form action="login.php" method="post"  onsubmit=" return requirea7a();">
              <input type="text" id="logbox" placeholder="Enter Your Old Password"><br><br><br><br>
              <input type="text" id="logbox1" placeholder="Enter Your New Password" name="newpass"><br><br><br><br>
              <input type="submit" id="logbut" value="Change Password" name="editpassnow"  onclick="requirea7a();">
            </form>
    ...
    <script>
      function requirea7a() {  
   var pass = document.getElementById("logbox").value;  
   var vpass = document.getElementById("logbox1").value;  
   if(pass == vpass)  
   {   
    console.log ("Done")
    return true;     
