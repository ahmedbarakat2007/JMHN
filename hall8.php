...
.logindown:hover .dropbtn {background-color: #3e8e41;}
    ...
    <body>
        ...
        <img src="Textures/hall8.jpg" id="hallimg2" draggable="false">
           <h1 class="h7">Hall 8</h1>
           ...
           <form action="submit.php" method="post">
            <a href="sus.php"><input type="submit" value="Rent Now" name="rented" id="btnhall"></a>
         </form>
        </div>
        <br>
        <br>
