<html>
    <head>
        <title>JMHN : Change Your Name</title>
    ...
    <body>
        ...
        <div class="aboutmain1">
            ...
            <form action="login.php" method="post">
              <input type="text" id="logbox" placeholder="Enter Your New Name" value=<?php echo $_SESSION["account"]; ?> name="newname"><br><br><br><br>
              <input type="submit" id="logbut" value="Save Changes" name="editnow">
            </form>
